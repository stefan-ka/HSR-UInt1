...
public class ProxyLibrary implements LibraryData {
	...
	public List<Customer> getCustomers() {
		if (customers == null) {
			customers = getData("customers", new TypeToken<List<Customer>>() {
			}.getType());
		}
		return customers;
	}
	...
	public List<Loan> getLoans() {
		if (loans == null) {
			loans = getData("loans", new TypeToken<List<Loan>>() {
			}.getType());
		}
		return loans;
	}
	...
	public List<Reservation> getReservations() {
		if (reservations == null) {
			reservations = getData("reservations", new TypeToken<List<Reservation>>() {
			}.getType());
		}
		return reservations;
	}
	...
	public List<Gadget> getGadgets() {
		if (gadgets == null) {
			gadgets = getData("gadgets", new TypeToken<List<Gadget>>() {
			}.getType());
		}
		return gadgets;
	}
